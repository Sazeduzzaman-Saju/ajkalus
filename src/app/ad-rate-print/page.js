...
export const metadata = {
  title: "AD Rate Print :: Weekly Ajkal",
  description:
  ...
  openGraph: {
    type: "website",
    url: "https://www.ajkal.us/ad-rate-print",
  ...
  canonicalUrl: "https://www.ajkal.us/ad-rate-print", // Ensure this is the correct URL
};
const page = () => {
  return <div>ad-rate-print</div>;
};
